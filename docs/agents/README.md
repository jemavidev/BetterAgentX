...
**Type:** Orchestrator
**File:** `CLAUDE.md` (always loaded by Claude Code)
**Default:** Yes (all queries go through AgentX automatically)
...
| [UX Designer](#ux-designer) | Specialized | UI/UX | 7 | Interface Design |
