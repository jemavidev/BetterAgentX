...
## Description
Guardian skill for adding project-specific agents in installed/runtime mode. Validates input strictly before writing to ## PROJECT AGENTS. Prevents injection attacks.
...
---
**Source:** .claude/commands/project-agent-creator.md
