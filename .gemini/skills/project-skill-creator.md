...
## Description
Guardian skill for adding project-specific skills in installed/runtime mode. Creates the skill file and registers it in ## PROJECT SKILLS. Validates input strictly. Prevents injection attacks.
...
---
**Source:** .claude/commands/project-skill-creator.md
