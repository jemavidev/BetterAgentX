...
## Description
Use for critical analysis of proposals, architecture reviews, risk assessment, pre-mortem analysis, challenging assumptions, identifying blind spots, second-order thinking, and applying the Tenth Man Rule when the team seems too aligned.
