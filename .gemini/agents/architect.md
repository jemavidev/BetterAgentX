...
## Description
Use for system design, architecture patterns, technical planning, scalability decisions, database schema design, API design (REST/GraphQL/gRPC), technology stack evaluation, microservices vs monolith decisions, cloud architecture, DDD, CQRS, event-driven architecture, and technical debt assessment.
...
**Generated:** 2026-03-22T02:32:35.734Z
**Platform:** Gemini
