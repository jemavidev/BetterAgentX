...
## Description
View token usage, session statistics, and project metrics for the BetterAgents system. Shows LLM usage tracking, project size, and memory stats.
...
---
**Source:** .claude/commands/metrics.md
