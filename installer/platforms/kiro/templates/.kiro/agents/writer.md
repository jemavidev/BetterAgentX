...
## Description
Use for technical documentation, README files, API documentation (OpenAPI/Swagger), tutorials, guides, code comments, docstrings, user manuals, release notes, changelogs, and architecture documentation.
