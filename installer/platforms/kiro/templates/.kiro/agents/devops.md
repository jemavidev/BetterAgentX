...
## Description
Use for CI/CD pipeline design, Docker and Kubernetes configuration, infrastructure as code (Terraform/CloudFormation), cloud architecture (AWS/GCP/Azure), monitoring and observability, deployment strategies, security hardening, incident response, and performance optimization.
...
**Generated:** 2026-03-02T12:56:20.522Z
**Platform:** Kiro
