...
function resolveFilePath(pathname) {
  ...
  if (MULTI_PROJECT) {
    ...
    } else if (pathname.startsWith('/.betteragents/memory/')) {
      filePath = path.join(PROJECTS_BASE, pathname.replace('/.betteragents/memory/', ''));
    } else {
    ...
    if (pathname.startsWith('/memory/')) {
      ...
      filePath = path.join(MEMORY_DIR, pathname.replace('/.betteragents/memory/', ''));
    } else {
